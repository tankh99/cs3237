...
static void collateData() {
  ...
  cJSON_AddNumberToObject(one_data, "x", Xa);
  cJSON_AddNumberToObject(one_data, "y", Ya);
  cJSON_AddNumberToObject(one_data, "z", Za);
...
void loop()
{
  ...
  else if (sasToken.IsExpired())
  {
    ...
    collateData();
    next_collection_time_ms = millis() + 250;
  }
