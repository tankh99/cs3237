...
exports.ClaimsBasedSecurityAgent = void 0;
 ...
 */
class ClaimsBasedSecurityAgent extends events_1.EventEmitter {
    constructor(session) {
        super();
        ...
        this._senderLink = new sender_link_1.SenderLink(ClaimsBasedSecurityAgent._putTokenSendingEndpoint, null, this._rheaSession);
        /*Codes_SRS_NODE_AMQP_CBS_16_002: [The `constructor` shall instantiate a `ReceiverLink` object for the `$cbs` endpoint.]*/
        this._receiverLink = new receiver_link_1.ReceiverLink(ClaimsBasedSecurityAgent._putTokenReceivingEndpoint, null, this._rheaSession);
            ...
            states: {
                ...
                attached: {
                    ...
                    putToken: (audience, token, putTokenCallback) => {
                        ...
                        const amqpMessage = new amqp_message_1.AmqpMessage();
                ...
                detaching: {
                    _onEnter: (forwardedCallback, err) => {
                        ...
                        if (err) {
                            debugErrors('Detaching because of ' + (0, amqp_common_errors_1.getErrorName)(err));
                        }
    ...
    _removeExpiredPutTokens() {
        const currentTime = Math.round(Date.now() / 1000);
        const expiredPutTokens = [];
