...
function create(host, policy, key, expiry) {
    ...
    key - key
    expiry - expiry]*/
    return shared_access_signature_1.SharedAccessSignature.create(host, policy, key, expiry);
}
...
function parse(source) {
    ...
    return shared_access_signature_1.SharedAccessSignature.parse(source, ['sr', 'sig', 'skn', 'se']);
}
exports.parse = parse;
